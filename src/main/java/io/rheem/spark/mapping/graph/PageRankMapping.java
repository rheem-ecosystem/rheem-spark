package io.rheem.spark.mapping.graph;
...
/**
 * Mapping from {@link PageRankOperator} to io.rheem.spark.operators.graph.SparkPageRankOperator .
 */
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<PageRankOperator>(
                (matchedOperator, epoch) -> {
                    ...
                    try {
                        final Class<?> cls = Class.forName("io.rheem.spark.operators.graph.SparkPageRankOperator");
