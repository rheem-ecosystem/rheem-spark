...
public class ExtendedFunction<InputType, OutputType> implements Function<InputType, OutputType> {
    ...
    public <T extends Function<InputType, OutputType> & io.rheem.core.function.ExtendedFunction>
    ...
    public OutputType call(InputType v1) throws Exception {
        if (this.isFirstRun) {
            ((io.rheem.core.function.ExtendedFunction) this.impl).open(this.executionContext);
